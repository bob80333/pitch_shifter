...
from pitch_shifter.model.model_1d_vocos import VocosModel
...
def main(args):
    ...
    val_vctk_files = list(Path("dataset_dir/vctk_dataset/val_processed_v3").rglob("*.flac"))
    val_vctk_dataset = PreShiftedAudioDatasetV2(val_vctk_files, test=True, samples=16384 * 9)
